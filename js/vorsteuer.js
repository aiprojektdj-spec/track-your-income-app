                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ${entries.map(e => `<tr>
                                ...
                                <td><button class="btn btn-small btn-danger" title="Löschen" data-action="vst-del" data-args='["${e.id}"]' aria-label="Eintrag ${Utils.escapeHtml(e.lieferant || '')} vom ${Utils.escapeHtml(e.datum || '')} löschen"><i class="ti ti-trash"></i></button></td>
                            </tr>`).join('')}
                        </tbody>
                    </table>
                </div>
