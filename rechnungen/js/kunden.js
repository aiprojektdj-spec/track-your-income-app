var Kunden = (function() {
    ...
    function showCustomerForm(customer) {
        ...
        body += '<div class="form-group"><label class="form-label" for="cfFirma">Firma</label><input class="form-input" id="cfFirma" maxlength="200" value="' + Utils.escapeHtml(customer ? customer.firma || '' : '') + '"></div>';
        body += '<div class="form-group"><label class="form-label" for="cfAnsprech">Ansprechpartner</label><input class="form-input" id="cfAnsprech" maxlength="200" value="' + Utils.escapeHtml(customer ? customer.ansprechpartner || '' : '') + '"></div>';
        body += '</div>';
        body += '<div class="form-group"><label class="form-label" for="cfStrasse">Stra\u00DFe</label><input class="form-input" id="cfStrasse" maxlength="200" value="' + Utils.escapeHtml(customer ? customer.strasse || '' : '') + '"></div>';
        body += '<div class="form-row">';
        body += '<div class="form-group"><label class="form-label" for="cfPlz">PLZ</label><input class="form-input" id="cfPlz" maxlength="10" value="' + Utils.escapeHtml(customer ? customer.plz || '' : '') + '"></div>';
        body += '<div class="form-group"><label class="form-label" for="cfOrt">Ort</label><input class="form-input" id="cfOrt" maxlength="100" value="' + Utils.escapeHtml(customer ? customer.ort || '' : '') + '"></div>';
        body += '</div>';
        body += '<div class="form-row">';
        body += '<div class="form-group"><label class="form-label" for="cfEmail">E-Mail</label><input class="form-input" id="cfEmail" type="email" maxlength="150" value="' + Utils.escapeHtml(customer ? customer.email || '' : '') + '"></div>';
        body += '<div class="form-group"><label class="form-label" for="cfTelefon">Telefon</label><input class="form-input" id="cfTelefon" maxlength="40" value="' + Utils.escapeHtml(customer ? customer.telefon || '' : '') + '"></div>';
        body += '</div>';
        body += '<div class="form-row">';
        ...
        body += '<div class="form-group"><label class="form-label" for="cfUstIdNr">USt-IdNr. (B2B Ausland)</label><input class="form-input" id="cfUstIdNr" maxlength="20" placeholder="z.B. FR12345678901" value="' + Utils.escapeHtml(customer ? customer.ustIdNr || '' : '') + '"></div>';
        body += '</div>';
